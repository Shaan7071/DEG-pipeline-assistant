...
def get_pipeline_parameters(user_input_dict, pipeline_context=None):
    ...
    Analysis parameters:
    - model_organism: Model organism code. You may need to convert into the g:orth organism id if it isn't already e.g., "drerio" for zebrafish. The dict is here if needed: https://biit.cs.ut.ee/gprofiler/page/organism-list (string)
